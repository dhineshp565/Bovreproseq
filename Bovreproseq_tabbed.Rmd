...
output: 
  html_document:
  output_file: "Bovreroseq_report_`r Sys.Date()`.html"
params:
  csv: ""
  krona: ""
---
...
for (i in sampleid){
  ...
  table_html <- knitr::kable(results_df, align = "llll", caption = "RESULTS SUMMARY - Based on abricate results") %>%
    kable_styling()
  ...
  print(knitr::kable(mlst_final,align = "lcl",caption = "MLST tool from github (https://github.com/tseemann/mlst). Scans contig files against traditional PubMLST typing schemes") %>%
    kable_styling())
  }
  cat('\n\n<!-- -->\n\n')
