...
for (i in sampleid){
  ...
  results <- read.csv(paste(i,"_results.csv",sep=""))
  ...
  print(knitr::kable(mapped_stat,align="ll",caption = "NO. OF MAPPED READS. Generated using minimap2 and samtools")) # displat table
  cat('\n\n<!-- -->\n\n') 
